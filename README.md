...
```
├── data/
│   ├── finnhub_articles.csv          # 40,112 collected articles
│   ├── earnings_data.csv             # Quarterly earnings surprises
│   └── stock_prices.csv              # Daily price data (yfinance)
│
├── notebooks/
│   ├── text_prep.qmd                 # Text preprocessing walkthrough
│   ├── sentiment_analysis.qmd        # Sentiment analysis walkthrough
│   └── topic_models.qmd              # Topic modeling walkthrough
│
├── src/
│   ├── part1_data_loading_eda.py     # Data collection & EDA
│   ├── part2_text_preprocessing.py   # Cleaning, stopwords, TF-IDF
│   ├── part3_sentiment_analysis.py   # VADER & TextBlob scoring
│   ├── part4_topic_modeling.py       # LDA (5 topics, 500 iterations)
│   ├── part5_market_impact.py        # Returns, correlations, OLS
│   └── part6_summary_conclusions.py  # Final visualizations
│
